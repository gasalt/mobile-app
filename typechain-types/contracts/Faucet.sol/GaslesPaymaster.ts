...
export interface GaslesPaymasterInterface extends utils.Interface {
  functions: {
    ...
    "addToOwner(address)": FunctionFragment;
    ...
    "targets(address)": FunctionFragment;
    "transferOwnership(address)": FunctionFragment;
    "updateTarget(address,bool)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "addToOwner", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getGasAndDataLimits",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "TargetChanged(address,address,bool)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "TargetChanged"): EventFragment;
}
...
export interface TargetChangedEventObject {
  newTarget: string;
  by: string;
  status: boolean;
}
export type TargetChangedEvent = TypedEvent<
  [string, string, boolean],
  TargetChangedEventObject
>;

export type TargetChangedEventFilter = TypedEventFilter<TargetChangedEvent>;

export interface GaslesPaymaster extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GaslesPaymasterInterface;
  ...
  filters: {
    ...
    "TargetChanged(address,address,bool)"(
      newTarget?: null,
      by?: null,
      status?: null
    ): TargetChangedEventFilter;
    TargetChanged(
      newTarget?: null,
      by?: null,
      status?: null
